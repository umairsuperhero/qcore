...
**Current revision:** v1.22 — 2026-06-15
**Auditor of record this revision:** AUTS/SQN resync interop validation on
`codex/auts-sqn-interop`; first-hand Docker `go build`/`vet`/`test -race ./...` and a
green `ueransim-interop` run with a real UERANSIM SQN-desync replay.
